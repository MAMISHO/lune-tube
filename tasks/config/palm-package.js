...
module.exports = function(grunt) {
    ...
    grunt.config.set('shell', {
        ...
        android:  {
            command: [
                'rm -r ./cordova/www/*',
                'cp -r ./deploy/* ./cordova/www/',
                '(cd ./cordova; cordova build android)',
                //'(cd /Users/Developer/Desarrollo/movil/lune-tube; cordova run android)',
                'cp -r ./playground-code/android-deploy/index.html ./cordova/platforms/android/assets/www',
                'cp -r ./playground-code/android-deploy/cordova.js ./cordova/platforms/android/assets/www'
            ].join('&&')
        },
        default: {
