...
isApiReady: !1,
apiReady: function() {
enyo.YouTube.isApiReady = !0, enyo.Signals.send("onApiReady");
},
...
this.setPlayerShowing(!0), this.play();
},
...
this.videoId ? this.player ? (this.player.loadVideoById(this.videoId), this.setPlayerShowing(!0)) : this.createPlayer() : (this.setPlayerShowing(!1), this.pause());
},
setPlayerShowing: function(e) {
this.$.video.setShowing(e);
},
play: function() {
...
components: [ {
name: "input",
classes: "enyo-view-fit search-input",
tag: "input",
...
classes: "enyo-fit search-button",
style: "left: auto; width: 39px;",
tag: "img",
...
components: [ {
name: "back",
classes: "enyo-fit back-bar theme-fu dark",
style: "height: 50px;",
components: [ {
tag: "button",
content: "Back",
...
kind: "Scroller",
vertical: "hidden",
style: "top: auto; height: 100px;",
classes: "enyo-fit related-list"
} ]
} ],
create: function() {
this.inherited(arguments), this.searchQueryChanged();
},
rendered: function() {
this.inherited(arguments), this.validateLayout();
},
resizeHandler: function() {
this.validateLayout();
},
...
var e = this.getBounds().width < this.smallifyWidth;
e !== this.smallified && (this.smallified = e, this.$.left.applyStyle("width", e ? null : this.leftWidth), this.$.main.applyStyle("left", e ? "0" : this.leftWidth), this.$.client.applyStyle("top", e ? "50px" : "0"), this.$.back.setShowing(this.smallified)), this.$.main.setShowing(!this.smallified || this.isViewingDetail), this.$.left.setShowing(!this.smallified || !this.isViewingDetail);
},
showDetailView: function() {
this.isViewingDetail = !0, this.validateLayout();
},
showSearchView: function() {
this.isViewingDetail = !1, this.validateLayout();
},
inputKeypress: function(e, t) {
t.keyCode == 13 && this.search();
},
searchQueryChanged: function() {
this.$.input.setAttribute("value", this.searchQuery), this.search();
},
getSearchQuery: function() {
return this.$.input.hasNode() ? this.$.input.node.value : this.searchQuery;
},
search: function() {
this.$.spinner.setShowing(!0), this.doSearch({
...
for (var t = 0, n = e, r; r = n[t]; t++) this.$.related.createComponent({
tag: "img",
src: r.thumbnail,
...
preventTouchstart: function(e, t) {
t.preventDefault();
}
});
